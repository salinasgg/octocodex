<?php
// mail_phpmailer.php - Envío de correos usando PHPMailer
...
try {
    ...
    if ($success !== false) {
        // Intentar enviar el correo usando la función mail() nativa
        $mailSent = false;
        $mailError = '';
        ...
        echo json_encode([
            ...
            'note' => $mailSent ? 'El mensaje ha sido enviado por correo electrónico a salinasgeganb@gmail.com.' : 'El mensaje ha sido guardado en el servidor. Para recibir correos electrónicos, configura un servidor SMTP.',
            'debug_info' => [
                'nombre' => $nombre,
                'email' => $email,
                'asunto' => $asunto,
