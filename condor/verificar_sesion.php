...
if (isset($_SESSION['logged_in']) && $_SESSION['logged_in']) {
    ...
    echo "<li><strong>us_nombre:</strong> " . ($_SESSION['us_nombre'] ?? 'No definido') . "</li>";
    echo "<li><strong>us_apellido:</strong> " . ($_SESSION['us_apellido'] ?? 'No definido') . "</li>";
...
echo "<li><a href='admin/dashboard.php'>📊 Dashboard Principal</a></li>";
