<?php
// mail_phpmailer_real.php - Envío de correos usando PHPMailer real
...
// Crear contenido del mensaje para archivo
$messageContent = "
...
try {
    ...
    if ($success !== false) {
        // Intentar enviar el correo usando PHPMailer si está disponible
        $mailSent = false;
        $mailError = '';
        ...
        if (file_exists('PHPMailer/PHPMailer.php')) {
            ...
            try {
                ...
                // Configuración del correo
                $mail->setFrom('noreply@devstudio.com', 'DevStudio Contact Form');
            ...
            if (function_exists('mail')) {
                ...
                $mailError = 'Función mail() no disponible y PHPMailer no está instalado';
            }
        }
        ...
        if ($mailSent) {
            $logEntry .= " - Email enviado exitosamente a {$to}\n";
        } else {
        ...
        echo json_encode([
            ...
            'note' => $mailSent ? 'El mensaje ha sido enviado por correo electrónico a salinasgeganb@gmail.com.' : 'El mensaje ha sido guardado en el servidor. Para recibir correos electrónicos, configura un servidor SMTP o instala PHPMailer.',
            'debug_info' => [
                'nombre' => $nombre,
                'email' => $email,
                'asunto' => $asunto,
                ...
                'phpmailer_available' => file_exists('PHPMailer/PHPMailer.php')
            ]
        ]);
    } else {
